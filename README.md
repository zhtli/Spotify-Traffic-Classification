...
Inside the folder `spotify_data_capture_process` you will find the script used to capture data from an interface while running spotify. This was also used as a baseline for the classifiers to capture specific data to train and test models.

## Classifiers
### Audio Quality Classifier
Inside the folder `audio_quality_classifier`...
